...
const PROJECTS = [
  {
    title: "קוד מאסטר 🤖",
    description: "משחק לימוד תכנות אינטראקטיבי בסגנון Duolingo — אתגרי קוד, מערכת XP, רמות ותגים. מתאים למתחילים שרוצים ללמוד JavaScript בדרך מהנה.",
    url: "./code-quest/",
    icon: "🤖"
  },
  {
    title: "יוצר ערכות נושא",
    description: "עצב ערכת נושא מותאמת אישית לטלפון! בחר צבעים, סגנון רקע, פונט ועוד — ראה תצוגה מקדימה חיה על מסך טלפון והורד את הטפט.",
    url: "./theme-creator/",
    icon: "🎨"
  },
  {
    title: "Sitio — פלטפורמת וידאו",
    description: "פלטפורמת וידאו מלאה! העלה סרטונים, צפה, לייק, תגובות, מנויים, טרנדים, תמונת פרופיל וחיפוש — הכל נשמר בדפדפן.",
    url: "./social-network/",
    icon: "🎬"
  },
  {
  ...
  {
    title: "קוד מאסטר",
    description: "משחק לימוד JavaScript כיפי ומאתגר! 4 עולמות, 20 שאלות, לבבות, כוכבים וקונפטי. מכסה משתנים, תנאים, לולאות ופונקציות — מושלם למתחילים.",
    url: "./code-quest/",
    icon: "🤖"
  },
  {
